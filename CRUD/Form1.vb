...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Else
                ...
                Dim InputData As String = "Insert into mahasiswa values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "')"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            Else
                ...
                Dim EditData As String = "Update mahasiswa set nama='" & TextBox2.Text & "',alamat='" & TextBox3.Text & "',jurusan='" & TextBox4.Text & "', kelas='" & TextBox5.Text & "' where id='" & TextBox1.Text & "'"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
            ...
            Else
                ...
                Dim HapusData As String = "delete from mahasiswa where id='" & TextBox1.Text & "'"
        ...
        End If
    End Sub
    ' ini adalah sebuah keypress jadi maksudnya adalah ketika kita mau edit dan hapus kita harus mengisi semua field ya kan ?
    ' nah om bewok punya solusinya, kita hanya memasukan nim nya lalu kita tekan enter, maka fieldnya akan terisi
    ' nah om bewok buatin nih caranya yuk om bewok perjelas satu - satu ya
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox1.KeyPress
        ...
        If e.KeyChar = Chr(13) Then
            ...
            Cmd = New OdbcCommand("Select * from mahasiswa where id='" & TextBox1.Text & "'", Conn)
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If TextBox6.Text <> "" Then
            Call Koneksi()
            Dim queryByID As String = "SELECT * FROM mahasiswa WHERE id = '" & TextBox6.Text & "'"
            Cmd = New OdbcCommand(queryByID, Conn)
            Dim reader As OdbcDataReader = Cmd.ExecuteReader()
            If reader.Read() Then
                TextBox1.Text = reader("id").ToString()
                TextBox2.Text = reader("nama").ToString()
                TextBox3.Text = reader("alamat").ToString()
                TextBox4.Text = reader("jurusan").ToString()
                TextBox5.Text = reader("kelas").ToString()
                Button2.Enabled = True
                Button2.Text = "UPDATE"
                Button1.Enabled = False
                Button4.Text = "BATAL"
